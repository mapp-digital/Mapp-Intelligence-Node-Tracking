export declare class Properties {
    ...
    static readonly MAX_ATTEMPT: string;
    static readonly ATTEMPT_TIMEOUT: string;
    static readonly MAX_BATCH_SIZE: string;
    static readonly MAX_QUEUE_SIZE: string;
    static readonly MAX_FILE_LINES: string;
    static readonly MAX_FILE_DURATION: string;
    static readonly MAX_FILE_SIZE: string;
    static readonly FORCE_SSL: string;
}
